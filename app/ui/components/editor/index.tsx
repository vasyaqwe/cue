            ...
            {editor === null ? (
               <>
                  {content === "<p></p>" || content === "" ? (
                     <p
                        className={cn(
                           "prose mt-2 min-h-9 max-w-full break-words text-base text-foreground/40 prose-img:m-0 prose-p:my-2 prose-h2:mt-0 prose-h1:mb-3 prose-h2:mb-3 prose-code:after:hidden prose-code:before:hidden prose-ol:pl-4 prose-ul:pl-4 prose-code:text-sm prose-h1:text-2xl prose-h2:text-xl prose-headings:text-foreground prose-p:text-base focus:outline-none",
                           classAttr,
                        )}
                     >
                        {placeholder}
                     ...
                     <div
                        className={cn(
                           "prose mt-2 min-h-9 max-w-full break-words text-base prose-img:m-0 prose-p:my-2 prose-h2:mt-0 prose-h1:mb-3 prose-h2:mb-3 prose-code:after:hidden prose-code:before:hidden prose-ol:pl-4 prose-ul:pl-4 prose-code:text-sm prose-h1:text-2xl prose-h2:text-xl prose-headings:text-foreground prose-p:text-base focus:outline-none",
                           classAttr,
                        )}
               ...
               <EditorProvider
                  ...
                  editorProps={{
                     ...
                     attributes: {
                        ...
                        class: cn(
                           "prose mt-2 min-h-9 max-w-full break-words prose-img:m-0 prose-p:my-2 prose-h2:mt-0 prose-h1:mb-3 prose-h2:mb-3 prose-code:after:hidden prose-code:before:hidden prose-ol:pl-4 prose-ul:pl-4 prose-code:text-sm prose-h1:text-2xl prose-h2:text-xl prose-headings:text-foreground prose-p:text-base focus:outline-none",
                           classAttr,
                        ),
                     },
                  }}
