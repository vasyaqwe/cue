      ...
      >
         ...
         <div className="flex-1">
            <div className="-mt-[4px] flex max-h-[22px] items-center justify-between">
               ...
               <div className="-top-3 -right-3 flex items-center gap-0.5 rounded-full p-0.5 transition-opacity md:pointer-events-none md:group-hover:pointer-events-auto md:absolute md:group-hover:opacity-100 md:opacity-0 md:shadow-button">
